    ...
    <div className="lg:grid grid-cols-2 gap-10 items-center py-7 px-4">
      <div>
        <div className="lg:w-5/6 mx-auto">
          <h1 data-aos="zoom-out-right" className="text-primary dark:text-secondary md:text-6xl text-4xl font-bold uppercase md:mb-5 mb-2">
          ...
          <p
                    ...
                    data-aos-offset="200"
          className="md:my-6 my-3 inline-block text-start md:text-2xl text-xl font-semibold text-primary hover:text-secondary dark:text-secondary dark:hover:text-primary">
            <Link
              to={`/services`}
