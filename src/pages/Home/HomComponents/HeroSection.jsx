    ...
    <div className="lg:grid grid-cols-2 gap-10 items-center py-7 px-4">
      <div>
        <div className="lg:w-5/6 mx-auto">
          <h1 className="text-primary dark:text-secondary md:text-6xl text-4xl font-bold uppercase">
          ...
          <p className="my-6 inline-block text-start text-2xl font-semibold text-primary hover:text-secondary dark:text-secondary dark:hover:text-primary">
            <Link
              to={`/services`}
